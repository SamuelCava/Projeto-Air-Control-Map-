...
// Raylib exibicao
    ...
    const int screenHeight = 2100;

    InitWindow(screenWidth, screenHeight, "Mapa de Controle de Tráfego Aereo - Version 1");
    
    SetTargetFPS(60);  

    Texture2D mapa_fundo = LoadTexture("C:\Users\lucas\Documents\Projeto Samuel Mapa de Controle de Trafego Aereo\imagens\mapa-capitais-brasil.png");
